...
library(tidyverse)
library(here)
data <- read_csv(here("../data/istih.csv"))
install.packages("readr")
library(readr)
csv_path <- "C:/Users/90538/OneDrive/Masaüstü/istatistik_final/istatistik_final/data/istih.csv"
...
```{r, echo=FALSE}
library(xtable) 
# devtools::install_github("ZeynepUstaa/istatistik_final")
